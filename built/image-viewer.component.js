    ...
    function ImageViewer() {
        ...
        _this.saveToLocal = function () {
            if (!_this.props.onSave) {
                react_native_1.CameraRoll.saveToCameraRoll(_this.props.imageUrls[_this.state.currentShowIndex || 0].uri);
                _this.props.onSaveToCamera(_this.state.currentShowIndex);
            }
            else {
                _this.props.onSave(_this.props.imageUrls[_this.state.currentShowIndex || 0].uri);
            }
    ...
    ImageViewer.prototype.loadImage = function (index) {
        ...
        if (image.width && image.height) {
            if (this.props.enablePreload && imageLoaded === false) {
                react_native_1.Image.prefetch(image.uri);
            }
        ...
        react_native_1.Image.getSize(image.uri, function (width, height) {
            ...
            switch (imageInfo.status) {
                ...
                case 'success':
                    ...
                    if (typeof image.props.source === 'number') {
                        ...
                        image.props.source = __assign({ uri: image.uri }, image.props.source);
                    }
                ...
                case 'fail':
                    return (<Wrapper key={index} style={[_this.styles.modalContainer, { borderWidth: 1, borderColor: "#f00" }]} imageWidth={_this.props.failImageSource ? _this.props.failImageSource.width : screenWidth} imageHeight={_this.props.failImageSource ? _this.props.failImageSource.height : screenHeight}>
                        {_this.props.failImageSource &&
                            _this.props.renderImage({
                                source: {
                                    uri: _this.props.failImageSource.uri
                                },
                                style: {
